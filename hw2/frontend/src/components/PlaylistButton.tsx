...
const PlaylistButton = ({
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get("/lists") // Adjust the endpoint as per your API
      .then((response) => {
  ...
  const handleExport = () => {
    ...
    axiosInstance
      .put(`/lists/${selectedPlaylist}/songs`, { songIds: selectedRows })
      .then((response) => {
  ...
  return (
    <div>
      ...
      <Button variant="contained" color="secondary" onClick={handleOpenExport}>
        Export
      </Button>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              setNewSong((prev) => ({ ...prev, author: e.target.value }))
            }
          />
          <TextField
            margin="dense"
            ...
            value={newSong.link}
            onChange={(e) =>
              setNewSong((prev) => ({ ...prev, link: e.target.value }))
            }
          />
        </DialogContent>
        <DialogActions>
