    ...
    <div className="view-post-container">
      <div className="view-post-header">
        <div className="view-post-date">
          {post.date && formatTime(post.date)}
        </div>
          ...
          <div className="view-post-tags">
            {post.tags &&
              post.tags.map((tag, index) => (
                <div className="view-tags" key={index}>
                  {tag}
                </div>
              ))}
          </div>
          <div className="view-post-moods">
            {post.moods &&
              post.moods.map((mood, index) => (
                <div className="view-moods" key={index}>
                  {mood}
                </div>
              ))}
          </div>
      ...
      <div className="view-post-content-text">{post.content}</div>
    </div>
  );
}
